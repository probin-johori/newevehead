...
const subscription: Subscription = { id: "sub1", org_id: "u7", plan: "pro", slots_total: 4, slots_used: 4 };
...
const tasks: Task[] = [
  { id: "t1", event_id: "e1", dept_id: "d1", title: "Install front truss rig", description: "Set up the front truss rigging system for main stage lighting and speaker mounts.", assignee_id: "u1", deadline: "2026-03-01", priority: "high", status: "in-progress", created_by: "u7", created_at: "2026-02-15T10:00:00Z", labels: ["stage", "setup"], subtasks: [
  ...
  { id: "t2", event_id: "e1", dept_id: "d1", title: "Main stage sound check", description: "Full sound check of all speaker arrays, monitors, and microphone lines.", assignee_id: "u2", deadline: "2026-03-01", priority: "urgent", status: "not-started", created_by: "u7", created_at: "2026-02-16T10:00:00Z", labels: ["sound"], subtasks: [
  ...
  { id: "t3", event_id: "e1", dept_id: "d3", title: "Finalise menu with Chef Kumar", description: "Confirm final menu selections, dietary options, and presentation style.", assignee_id: "u3", deadline: "2026-11-05", priority: "normal", status: "in-progress", created_by: "u7", created_at: "2026-02-14T10:00:00Z", labels: ["catering"], subtasks: [
  ...
  { id: "t4", event_id: "e1", dept_id: "d3", title: "Crockery rental arrangement", description: "Arrange rental of crockery, cutlery, and glassware for 500 guests.", assignee_id: "u4", deadline: "2025-09-25", priority: "high", status: "blocked", created_by: "u7", created_at: "2026-02-10T10:00:00Z", labels: ["logistics"], subtasks: [
  ...
  { id: "t5", event_id: "e1", dept_id: "d6", title: "Guest registration setup", description: "Set up registration desks, badge printing, and guest check-in flow.", assignee_id: "u5", deadline: "2026-11-01", priority: "high", status: "not-started", created_by: "u7", created_at: "2026-02-12T10:00:00Z", labels: ["hospitality"], subtasks: [
  ...
  { id: "t6", event_id: "e1", dept_id: "d6", title: "VIP lounge preparation", description: "Prepare the VIP lounge area with refreshments, seating, and branding.", assignee_id: "u5", deadline: "2026-11-01", priority: "high", status: "backlog", created_by: "u7", created_at: "2026-02-13T10:00:00Z", labels: ["VIP"], subtasks: [
  ...
  { id: "t7", event_id: "e1", dept_id: "d2", title: "LED panel configuration", description: "Configure all LED panels for the main stage backdrop.", assignee_id: "u2", deadline: "2026-03-12", priority: "normal", status: "in-review", created_by: "u7", created_at: "2026-02-20T10:00:00Z", labels: ["lighting"], subtasks: [
  ...
  { id: "t8", event_id: "e1", dept_id: "d7", title: "WiFi network deployment", description: "Deploy WiFi access points across the venue for staff and guests.", assignee_id: "u6", deadline: "2026-03-13", priority: "normal", status: "completed", created_by: "u7", created_at: "2026-02-18T10:00:00Z", labels: ["IT"], subtasks: [
...
const bills: Bill[] = [
  { id: "b1", event_id: "e1", dept_id: "d2", vendor_name: "AV Rentals India", description: "LED panel rental and AV equipment for main stage", amount: 95000, advance_amount: 40000, bill_file_url: "av_rentals_inv_001.pdf", invoice_number: "AVR-2026-001", status: "dept-verified", advance_status: "advance-given", category: "Equipment", submitted_by: "u1", dept_verified_by: "u2", ca_approved_by: null, settled_by: null, submitted_at: "2026-02-20T10:00:00Z", dept_verified_at: "2026-02-21T14:00:00Z", ca_approved_at: null, settled_at: null, due_date: "2026-03-10", invoice_file: "av_rentals_inv_001.pdf" },
  { id: "b2", event_id: "e1", dept_id: "d3", vendor_name: "Chef Kumar Catering", description: "Advance for catering supplies and raw materials", amount: 520000, advance_amount: 200000, bill_file_url: "chef_kumar_inv_045.pdf", invoice_number: "CKC-2026-045", status: "pending", advance_status: "advance-given", category: "Catering", submitted_by: "u3", dept_verified_by: null, ca_approved_by: null, settled_by: null, submitted_at: "2026-02-25T09:00:00Z", dept_verified_at: null, ca_approved_at: null, settled_at: null, due_date: "2026-03-05", invoice_file: "chef_kumar_inv_045.pdf" },
  { id: "b3", event_id: "e1", dept_id: "d2", vendor_name: "LightMasters Pvt Ltd", description: "Complete lighting setup and ambient design for venue", amount: 280000, advance_amount: 100000, bill_file_url: "lightmasters_inv_112.pdf", invoice_number: "LM-2026-112", status: "settled", advance_status: "settled", category: "Lighting", submitted_by: "u1", dept_verified_by: "u2", ca_approved_by: "u6", settled_by: "u7", submitted_at: "2026-02-10T11:00:00Z", dept_verified_at: "2026-02-11T10:00:00Z", ca_approved_at: "2026-02-12T09:00:00Z", settled_at: "2026-02-13T09:00:00Z", due_date: "2026-02-15", paid_date: "2026-02-13", invoice_file: "lightmasters_inv_112.pdf" },
  { id: "b4", event_id: "e1", dept_id: "d1", vendor_name: "ProSound Systems", description: "Sound system rental for main stage and breakout rooms", amount: 380000, advance_amount: 150000, bill_file_url: "prosound_inv_089.pdf", invoice_number: "PSS-2026-089", status: "pending", advance_status: "advance-given", category: "Equipment", submitted_by: "u2", dept_verified_by: null, ca_approved_by: null, settled_by: null, submitted_at: "2026-02-26T10:00:00Z", dept_verified_at: null, ca_approved_at: null, settled_at: null, due_date: "2026-03-12", invoice_file: "prosound_inv_089.pdf" },
  { id: "b5", event_id: "e1", dept_id: "d4", vendor_name: "TransLogix India", description: "Transport vehicles for equipment and staff shuttle", amount: 45000, advance_amount: 15000, bill_file_url: "translogix_inv_033.pdf", invoice_number: "TLI-2026-033", status: "ca-approved", advance_status: "advance-given", category: "Transport", submitted_by: "u4", dept_verified_by: "u4", ca_approved_by: "u6", settled_by: null, submitted_at: "2026-02-22T10:00:00Z", dept_verified_at: "2026-02-23T10:00:00Z", ca_approved_at: "2026-02-24T10:00:00Z", settled_at: null, due_date: "2026-03-01", invoice_file: "translogix_inv_033.pdf" },
];
